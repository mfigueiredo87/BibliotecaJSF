...
import ao.com.biblioteca.service.CadastroRequisitadoService;
import ao.com.biblioteca.service.NegocioException;
import ao.com.biblioteca.util.jsf.FacesUtil;

@Named
@ViewScoped
public class CadastroRequisitadoBean implements Serializable {
	...
	@Inject
	private CadastroRequisitadoService cadastroRequisitadoService;
	...
	public void salvar() {
		try {
			this.cadastroRequisitadoService.salvar(requisicao);
			FacesUtil.addSuccessMessage("Devolução feita com sucesso!");
